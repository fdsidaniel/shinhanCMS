<template>
  ...
  <ComResize />
  <v-card class="mt-5" outlined style="height: 400px">
    <v-card-title>트리셀렉트</v-card-title>
    <ComTreeSelect />
  </v-card>
  <ComResize />
  ...
  <v-card class="mt-5" outlined>
    ...
    <v-card-text>
      <ComSelectBox groupCode="01" v-model="comboSelected" :items="items" />
      <ComSelectBox groupCode="01" v-model="comboSelected" :items="items" :isDefault="false" />
  ...
  <v-card class="mt-5" outlined>
    ...
    <ComImage src="https://picsum.photos/500/300?image=15" />
  </v-card>
...
import ComSwiper from '@/components/common/ComSwiper.vue'
import ComResize from '@/components/common/ComResize.vue'
...
import ComTreeSelect from '@/components/common/ComTreeSelect.vue'
import ComImage from '@/components/common/ComImage.vue'
import PopupViewer from '@/components/common/PopupViewer.vue'
