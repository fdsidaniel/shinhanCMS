<template>
  ...
  <div class="conbody">
        ...
        <tr>
            ...
            <td>
              <div class="input_flex">
                <v-text-field label="제목" v-model="noticeTitle" :rules="noticeTitleRules" placeholder="" value="" class="i_basics flex1"></v-text-field>
                <ComSelectBox groupCode="01" v-model="comboOder" :items="itemsOder" value="null" class="s_basics w_120 ml_5" />
              </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
              <div class="i_calender">
                ...
                <v-checkbox v-model="checkbox1" class="ml_20" :label="`팝업 게시`" />
              </div>
            </td>
        </tr>
        <tr>
            <th>첨부파일</th>
            <td>
              <v-file-input v-show="true" id="fileElement" label="파일 업로드하기" v-model="fileupkoad" :rules="fileupkoadRules" class="file_upload"></v-file-input>
            </td>
        </tr>
        <tr>
            <th>내용</th>
            <td><v-textarea class="h_300"  :rules="textareaRules"></v-textarea><p class="txt_limit">0/50 자</p></td>
        </tr>
      </tbody>
    </v-table>
    ...
    <div class="btn_btm_wrap">
        ...
        <v-btn class="vbtn" size="large">신규 작성 완료</v-btn>
    </div>
  </div>
...
const comboOder = ref('000')
const itemsOder = ref([
  { title: '공지순서', value: '000' },
  { title: '1', value: '001' },
  { title: '2', value: '002' },
  { title: '3', value: '003' },
  { title: '4', value: '004' },
