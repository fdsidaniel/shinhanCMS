<template>
  ...
  <div class="conbody">
    ...
    <h3 class="stit">입금/잔액 조회<span class="date">(사업기간:2023-10-10 ~ 2023-10-10)</span><div class="unit">(단위:원)</div></h3>
    <v-table class="vtable_list">
      ...
      <tbody>
        <tr>
          <td class="t_right">500,000,000</td>
          <td class="t_right">470,000,000</td>
          <td class="t_right">453,941,532</td>
          <td class="t_right">16,058,468</td>
        </tr>
      </tbody>
    </v-table>

    <v-table class="vtable_list mt_40">
      <colgroup>
      <col style="width:30%;"/>
      <col style="width:30%;"/>
      <col style="width:40%;"/>
      ...
      <tbody>
        <tr>
          <td rowspan="6">직접비</td>
          <td class="tot">직접비 합계</td>
          <td class="tot t_right">206,970,766</td>
        </tr>
        <tr>
          <td>내부인건비</td>
          <td class="t_right">206,970,766</td>
        </tr>
        <tr>
          <td>외부인건비</td>
          <td class="t_right">-</td>
        ...
        <tr>
          <td>연구과제추진비</td>
          <td class="t_right">4,816,966</td>
        </tr>
        <tr>
          <td rowspan="2">간접비</td>
          <td class="tot">간접비 합계</td>
          <td class="tot t_right">20,000,000</td>
        </tr>
        <tr>
          <td>간접비</td>
