<template>
  ...
  <!-- popup size width:1000 height:900 -->
  <div class="popup_body" style="width:1000px;">
...
const columnDefsReceive = ref([
  ...
  {
    headerName: 'TASK 명', field: 'taskName', width: 465,
...
//   { headerName: '책임자', field: 'director', width: 120 },
  { headerName: 'TASK 시작일', field: 'startDate', width: 140 },
  { headerName: 'TASK 종료일', field: 'endDate', width: 140 },
  { headerName: 'TASK 상태', field: 'state', width: 140 },
])
