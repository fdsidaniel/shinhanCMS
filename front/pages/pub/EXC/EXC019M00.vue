<template>
  ...
  <div class="conbody">
    ...
    <h3 class="stit">사업비 취소 정보<div class="unit">(단위:원)</div></h3>
    ...
    <h3 class="stit">사업비 취소 금액 입금 계좌 정보<div class="unit">(단위:원)</div></h3>
    <v-table class="vtable_list none_head_line">
      <colgroup>
        <col style="width:289px;"/>
        <col style="width:289px;"/>
    ...
    <div class="btn_btm_wrap">
      <v-tooltip text="법인 인증서 인증을 완료하시면 이체가 실행됩니다." location="top" model-value>
        <template v-slot:activator="{ props }">
          <v-btn class="vbtn" size="large" v-bind="props">입금취소 이체 실행</v-btn>
        </template>
      </v-tooltip>
    </div>
