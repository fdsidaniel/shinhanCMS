<template>
  ...
  <div class="conbody">
    ...
    <v-table class="vtable_view">
        ...
        <tbody>
        <tr>
            <th class="req">기관 명</th>
            <td>
                <div class="input_flex">
                    <ComSelectBox groupCode="01" v-model="comboOrgName" :items="itemsOrgName" class="s_basics minw_120 mr_5" />
                    <v-text-field label="기관 명" v-model="orgName" :rules="orgNameRules" placeholder="신규 기관 명을 입력해주세요." class="i_basics w_334"></v-text-field>
        ...
        <tr>
            <th class="req">권한</th>
            <td>
                 <ComSelectBox groupCode="01" v-model="comboAuthority" :items="itemsAuthority" class="s_basics w_334" />
            </td>
        </tr>
        </tbody>
    </v-table>
...
const comboOrgName = ref('01')
const itemsOrgName = ref([
    { title: '직접입력', value: '01' },
    { title: '기관명1', value: '02' },
    { title: '한마정보통신', value: '03' },
])

const orgName = ref('')
const orgNameRules = [
  (v) => !!v || '기관 명을 선택하시거나 신규 기관 명을 입력해주세요.',
]
...
const comboAuthority = ref('01')
const itemsAuthority = ref([
    { title: '선택해주세요', value: '01' },
    { title: '시스템 관리자', value: '02' },
    { title: '기관 관리자', value: '03' },
])
